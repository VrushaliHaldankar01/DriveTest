...
module.exports = async (req, res) => {
  ...
  console.log("uppdatted", drivetest);
...
async function executeAfterRendering(req, res, userId, selectedDate) {
  // const drivetstest = await findAndUpdateById(dataid, storedata);
  // console.log("dddddddddd", drivetstest);
  const storedata = await DriveTest.findById(req.session.userId).exec();
  console.log("uppdatted", storedata);
  // const storedata = {
  //   firstName: "vvv",
  //   lastName: "vvv",
  //   licenseNumber: "vvv",
